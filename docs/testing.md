...
add Ash to the same visual gate as wgpu and Bevy for broad BLEND,
texture-transform, queue-matrix, alpha-mode, mask-texture, depth-stack, and
lighted MToon cases.
