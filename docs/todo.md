...
- [ ] Build the three-vrm render parity harness.
  ...
  - Remaining parity blockers: Bevy render capture, wgpu expression/runtime state, exact MToon light accumulation, secondary shade/matcap/rim/normal/outline texture paths, and higher PSNR thresholds.
