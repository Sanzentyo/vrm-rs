...
- [ ] Build the three-vrm render parity harness.
  ...
  - Remaining parity blockers: Bevy render capture, wgpu alpha/cull/material ordering, expression/runtime state, and fuller MToon lighting before PSNR thresholds can be meaningful.
