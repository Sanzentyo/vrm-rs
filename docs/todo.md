...
- [ ] Build the three-vrm render parity harness.
  ...
  - Remaining parity blockers: exact MToon light accumulation, Bevy/wgpu expression and runtime pose state, screen-coordinate outline details, broader fixture render parity, and higher PSNR thresholds.
