...
- [ ] Build the three-vrm render parity harness.
  ...
  - `tools/ci/local-ci.rs --render-parity` now regenerates three-vrm, wgpu, and Bevy Seed-san RGBA/PNG artifacts plus PSNR reports and `.external-fixtures/render-parity/visual-review.html` in one local command.
