...
render-parity-normal-maps-off three_vrm_root="D:/git/three-vrm":
    cargo +nightly -Zscript tools/ci/local-ci.rs -- --skip-core --skip-coverage --skip-download --skip-three-vrm-build --skip-playwright-install --render-parity --three-vrm-root "{{ three_vrm_root }}" --render-parity-dir .external-fixtures/render-parity-normal-maps-off --render-background opaque-black --render-alpha-mismatch-tolerance 0 --render-psnr-metric rgb-visible --render-fail-under 33 --render-mtoon-light-accumulation tuned --render-disable-normal-maps --render-fixture Seed-san.vrm --render-fixture VRM1_Constraint_Twist_Sample.vrm
...
render-parity-mtoon-light-direct-generated three_vrm_root="D:/git/three-vrm":
    ...
    cargo +nightly -Zscript tools/render-parity/compare-swatch-colors.rs --expected .external-fixtures/render-parity-mtoon-light-direct-generated/three-vrm/mtoon-light_vrm.frame000.rgba.json --actual .external-fixtures/render-parity-mtoon-light-direct-generated/wgpu/mtoon-light_vrm.frame000.rgba.json --names "{{ light_swatch_names }}" --fail-under 50 --max-channel-delta 1 --json-out .external-fixtures/render-parity-mtoon-light-direct-generated/reports/mtoon-light_vrm.wgpu.swatches.json
...
render-parity-mtoon-light-scaled-colored-generated three_vrm_root="D:/git/three-vrm":
    ...
    cargo +nightly -Zscript tools/render-parity/compare-swatch-colors.rs --expected .external-fixtures/render-parity-mtoon-light-scaled-colored-generated/three-vrm/mtoon-light_vrm.frame000.rgba.json --actual .external-fixtures/render-parity-mtoon-light-scaled-colored-generated/wgpu/mtoon-light_vrm.frame000.rgba.json --names "{{ light_swatch_names }}" --fail-under 50 --max-channel-delta 1 --json-out .external-fixtures/render-parity-mtoon-light-scaled-colored-generated/reports/mtoon-light_vrm.wgpu.swatches.json
...
render-parity-mtoon-light-ambient-generated three_vrm_root="D:/git/three-vrm":
    ...
    cargo +nightly -Zscript tools/render-parity/compare-swatch-colors.rs --expected .external-fixtures/render-parity-mtoon-light-ambient-generated/three-vrm/mtoon-light_vrm.frame000.rgba.json --actual .external-fixtures/render-parity-mtoon-light-ambient-generated/wgpu/mtoon-light_vrm.frame000.rgba.json --names "{{ light_swatch_names }}" --fail-under 50 --max-channel-delta 1 --json-out .external-fixtures/render-parity-mtoon-light-ambient-generated/reports/mtoon-light_vrm.wgpu.swatches.json
