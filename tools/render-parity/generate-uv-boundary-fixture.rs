...
#[command(
    name = "generate-uv-boundary-fixture",
    about = "Generate a source-like VRM1 glTF fixture for UV seam and triangle-boundary parity"
)]
struct Options {
    #[arg(
        long,
        default_value = ".external-fixtures/generated/uv-boundary.vrm.gltf"
    )]
    out: PathBuf,
}
...
fn fixture_json() -> String {
    ...
    serde_json::to_string_pretty(&json!({
        "asset": {
            "version": "2.0",
            "generator": "vrm-rs UV boundary render parity generator"
        },
        "extensionsUsed": [
            "VRMC_vrm",
        ...
        "extensions": {
            "VRMC_vrm": {
                "specVersion": "1.0",
                "meta": {
                    "name": "vrm-rs UV Boundary Fixture",
                    "authors": ["vrm-rs"],
