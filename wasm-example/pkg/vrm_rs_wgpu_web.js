/* @ts-self-types="./vrm_rs_wgpu_web.d.ts" */

/**
 * @param {number} delta_x
 * @param {number} delta_y
 */
export function orbit_wgpu_vrm_camera(delta_x, delta_y) {
    const ret = wasm.orbit_wgpu_vrm_camera(delta_x, delta_y);
    if (ret[1]) {
 ...
 * @param {number} delta_y
 */
export function pan_wgpu_vrm_camera(delta_x, delta_y) {
    const ret = wasm.pan_wgpu_vrm_camera(delta_x, delta_y);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 */
export function pointer_button_wgpu_vrm_ui(x, y, pressed) {
    const ret = wasm.pointer_button_wgpu_vrm_ui(x, y, pressed);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

export function pointer_leave_wgpu_vrm_ui() {
    const ret = wasm.pointer_leave_wgpu_vrm_ui();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {number} y
 */
export function pointer_move_wgpu_vrm_ui(x, y) {
    const ret = wasm.pointer_move_wgpu_vrm_ui(x, y);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

export function reset_wgpu_vrm_camera() {
    const ret = wasm.reset_wgpu_vrm_camera();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {Uint8Array} avatar_bytes
 * @param {Uint8Array} animation_a_bytes
 * @param {Uint8Array} animation_b_bytes
 * @returns {Promise<void>}
 */
export function start_wgpu_vrm_viewer(canvas_id, avatar_bytes, animation_a_bytes, animation_b_bytes) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(avatar_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(animation_a_bytes, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArray8ToWasm0(animation_b_bytes, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.start_wgpu_vrm_viewer(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
    return ret;
}

/**
 * @param {number} scroll_lines
 */
export function zoom_wgpu_vrm_camera(scroll_lines) {
    const ret = wasm.zoom_wgpu_vrm_camera(scroll_lines);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 1816, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h7ec3ab38493a6e4b);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 3747, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h6c25144d5ae393cd);
            return ret;
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [F64], shim_idx: 220, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h8af5695b96ccf15b);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./vrm_rs_wgpu_web_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h7ec3ab38493a6e4b(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h7ec3ab38493a6e4b(arg0, arg1, arg2);
}
...
function wasm_bindgen__convert__closures_____invoke__h8af5695b96ccf15b(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h8af5695b96ccf15b(arg0, arg1, arg2);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vrm_rs_wgpu_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
